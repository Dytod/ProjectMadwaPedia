...
import PopularMobileCard from "../components/PopularMobileCard";
...
const Home8 = () => {
  ...
  return (
    <View style={[styles.home, styles.homeLayout]}>
      ...
      <View style={[styles.appLogo, styles.systemLayout]}>
        <Image
          style={[styles.icon, styles.childPosition]}
          contentFit="cover"
      ...
      <View style={[styles.component4, styles.componentLayout]}>
        <Image
          style={[styles.component4Child, styles.childPosition]}
          contentFit="cover"
          source={require("../assets/rectangle-32.png")}
        />
        <View style={styles.component4Item} />
        <View style={[styles.component4Inner, styles.frameViewPosition]} />
...
Mobile`}</Text>
      ...
      <View style={[styles.component5, styles.componentPosition2]}>
        <Image
          style={[styles.component5Child, styles.childPosition]}
          contentFit="cover"
